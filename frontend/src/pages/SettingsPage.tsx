  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8 px-4 py-8 sm:px-6">
      ...
      <section>
        ...
        <div className="rounded-xl border border-slate-100 bg-white p-5 shadow-[0_4px_20px_-2px_rgba(79,70,229,0.1)] dark:border-slate-700 dark:bg-slate-900">
          {user ? (
            <div className="space-y-0">
              {(
                ...
                <div key={label} className="flex items-baseline justify-between border-b border-slate-100 py-3 last:border-0 dark:border-slate-700">
