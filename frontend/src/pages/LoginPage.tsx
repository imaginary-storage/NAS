...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-slate-50 p-5 dark:bg-[#0C0F1A]">
      ...
      <div className="relative z-10 flex w-full max-w-[820px] items-start gap-7">
        ...
        {/* Sessions panel */}
        <div className="flex-1 rounded-xl border border-slate-100 bg-white p-7 shadow-[0_4px_20px_-2px_rgba(79,70,229,0.1)] dark:border-[#1E2640] dark:bg-[#161B2E]">
